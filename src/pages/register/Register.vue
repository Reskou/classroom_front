<template>
  <div>
    <div>
      <el-button type="primary" icon="el-icon-back" class="back" @click="backToHome"></el-button>
    </div>
    <div class="login-wrap">
      <el-form class="login-container">
        <h1 class="title">用户注册</h1>
        <el-form-item>
          <el-input type="text" v-model="name" placeholder="用户名" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input type="password" v-model="password" placeholder="用户密码" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
          <el-input type="text" v-model="telephone" placeholder="手机号" autocomplete="off"></el-input>
        </el-form-item>
        <el-form-item>
...
export default {
  ...
  methods: {
    Register: function () {
      ...
      let url = "http://localhost:8339/user/register";
      let params = {
        name: name,
        password: password,
        telephone: telephone
      ...
      axios.post(url, params).then(resp => {
        this.$message({
          ...
          message: this.name + "用户注册成功"
        });
        this.$store.state.isNotLogin = false;
